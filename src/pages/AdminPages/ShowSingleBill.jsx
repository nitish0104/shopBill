    ...
    <>
      ...
      {beforePrint && (
        <Link
          ...
          className="flex items-center justify-center w-12 h-12 rounded-full border mt-4"
        >
      ...
      >
        <div className="bg-white rounded-lg shadow-lg pb-4">
          <div className="flex justify-between bg-blue-500 text-white px-6 py-4 items-center">
            ...
            <p className="">
              Date: {moment(singleBill?.createdAt).format("DD MMM, YYYY")}
            </p>
          </div>
          ...
          <table className="w-full">
            ...
            <tfoot className="bg-gray-200 text-gray-800 ">
              ...
              <tr>
                ...
                <td className="py-2 pl-2 border-b border-black">{ singleBill?.discount} Rs</td>
              </tr>
              ...
              <tr>
                ...
                <td className="py-2 pl-2 font-bold">{singleBill?.grandtotal - singleBill?.discount} Rs</td>
              </tr>
            </tfoot>
          </table>
          {/* <div className=" ">
          ...
          <div className="px-4 pt-4 " ><p className="text-center font-bold text-xl">Thanks! Visit Again.</p></div>
        </div>
