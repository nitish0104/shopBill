...
const BillPreviewModal = ({ showModal, setShowModal, billID }) => {
  return (
    <>
      ...
      {showModal && (
        <section className="h-[90vh] w-[100vw] md:w-[90vw] fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white z-[1000]">
          <div className="flex justify-end md:px-5 py-4 text-red-500">
            <button
              onClick={() => {
                setShowModal(false);
              }}
